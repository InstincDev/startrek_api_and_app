...
const aliens = {
    "humans":{
        "speciesName":"Humans",
        "homeworld":"Earth",
        "features":"Rounded ears, hair on the head and face (sometimes)",
        "interestingFact":"Founded the United Federation of Planets after first contact with the Vulcans",
        "notableExamples":"James T. Kirk, Zephran Cochran, Abraham Lincoln",
    ...
    "trill":{
        "speciesName":"Trill",
        "homeworld":"Trill",
        "features":"Outward appearance similar to humans, aside from distinct dark pigment marks running symmetrically down both sides od the face and body",
